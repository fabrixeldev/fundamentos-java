        ...
        if (h % 2 == 0){
            for (int fila = 0; fila <= h ; fila++){
                for (int col = 0; col <= h; col++){
                    if (fila == 0 || col == h || col == 0 || fila == h || fila > 1 && fila < h - 1 && (col == 2 || col == h - 2)|| (fila == 2 || fila == h - 2) && col > 1 && col < h - 1){
                        System.out.print("*");
                    } else {
                        System.out.print(" ");
                    }
            ...
            for (int fila = 0; fila < h ; fila++){
                for (int col = 0; col < h; col++){
                    if (fila == 0 || col == h - 1 || col == 0 || fila == h - 1 || fila > 1 && fila < h - 2 && (col == 2 || col == h - 3) || (fila == 2 || fila == h - 3) && col > 1 && col < h - 2){
                        System.out.print("*");
                    } else {
                        System.out.print(" ");
                    }
